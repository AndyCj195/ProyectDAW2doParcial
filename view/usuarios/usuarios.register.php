                ...
                <div class="form-row">
                    <div class="seccion" style="display: block;">
                        <div id="div-nombre">
                            ...
                            <input type="text" id="input-nombres" name="nombreEncrypted">
                    ...
                    <div class="seccion" style="display: block;">
                        <div class="div-correo">
                            ...
                            <input type="email" id="input-correo" name="correoEncrypted">
                    ...
                    <div class="seccion">
                        <div class="div-CI">
                            ...
                            <input type="text" id="input-cedula" name="cedulaEncrypted">
                            <div class="error-message" id="error-cedula"></div>
                        </div>
                        <div class="div-telefono">
                            <label for="telefono">Telefono</label><br>
                            <input type="text" id="input-telefono" name="telefonoEncrypted">
                    ...
                    <div class="seccion">
                        <div class="div-contrasena">
                            ...
                            <input type="password" id="contrasena" name="contrasenaEncrypted">
                        ...
                        <div class="div-contra2">
                            ...
                            <input type="password" id="idContrasena2" name="contrasenaConfirmEncrypted">
